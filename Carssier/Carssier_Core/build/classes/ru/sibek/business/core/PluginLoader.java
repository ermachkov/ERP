...
public class PluginLoader {
    ...
    public PluginLoader() {
        ...
        homeDir = System.getProperty("user.home") + File.separator + ".lombard"
    ...
    public void loadPlugins(List<Plugin> ps) {
        ...
        //ArrayList<WorkPanelPlugin> ribbonPlugins = new ArrayList<>();
        //ribbonPlugins.addAll(wpps.values());
    }
