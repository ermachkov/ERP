 ...
 */
public class ReplicationTestUINode extends javax.swing.JFrame {

    private DataBase dataBase;

    /** Creates new form ReplicationTestUI */
    public ReplicationTestUINode() {
        initComponents();

        String dbPath = System.getProperty("user.home") + File.separator
                + ".saas_node" + File.separator + "app" + File.separator + "config"
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReplicationTestUINode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ReplicationTestUINode().setVisible(true);
            }
        });
    }
