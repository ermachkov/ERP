...
public class Event implements Serializable {
    ...
    public static int ADD = 0, MODIIFY = 1, DELETE = 2, SYNC_START = 3, SYNC_COMPLITE = 4;

    public Event(Map eventMap) throws Exception {
     ...
     * 
     * @param syncStatus 
     * Shoulde be Event.SYNC_START or Event.SYNC_COMPLITE
     */
    public Event(int syncStatus){
        action = syncStatus;
    }
