...
public class DataFileChannelTest {
    ...
    public DataFileChannelTest() {
        ...
        dataBase.setProperties("/home/developer/NetBeansProjects/JSSDB/test/db.properties");
        dataBase.initMe();
    }
    ...
    private void modify() throws ClassNotFoundException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            while (it.hasNext()) {
                ...
                String newName = dfc.getName() + " 10";
                dfc.setName(newName);
                q.updateObject(id, dfc);
                System.out.println("Updated " + i + ", " + dfc);
            }
        }
    }
    ...
    private void delete() throws ClassNotFoundException {
        ...
        for(long id : deleteList){
            q.deleteObject(id, DFC.class.getName());
        }
    }
