...
var sess = parseInt(Math.random() * 10000000) + "-" + parseInt(Math.random() * 10000000);
...
//    var json = {
//        "identificator":"ru.sibek.core.ui.UILogin", 
//        "eventType":"push",
//        "action":"logout"
//    };
...
function UICore() {
    ...
    //var TabLabelList = new Array();
    var isSwitchToEdit = false;
    var isFirstClick = false;
    var selectionStart = 0;
    var lastSelectedWorkPanel = "";
    var loginPanel = "ru.sibek.core.ui.UILogin";
    ...
    this.getSelectedWorkPanel = function(){
        return "{\"selectedPanel\":\"" + lastSelectedWorkPanel + "\"}";
    }
    ...
    this.showLoginPanel = function(panel){
        ...
        $(".btnLoginOk").button().click(function(event){
            var json = {
        ...
        $(".btnLoginCancel").button().click(function(event){
            var json = {
                "identificator":"" + $(this).attr("identificator"), 
                "eventType":"click"
            };
    ...
    this.showConfirmPanel = function(title, message){
        ...
        $(".confirmPanel").find("button").click(function(event){
            var json = {
                "identificator":"" + $(this).attr("identificator"), 
                "eventType":"click"
            };
    ...
    this.setTopButtonsModel = function(model) {
        ...
        $("#ribbonTopPanel tbody").click(function(event) {
            var tdElements = $("#ribbonTopPanel").find("td");
            for(var i = 0; i < tdElements.length; i++){
                $("#ribbonTopPanel").find("td")[i].className = 'ribbon_top_button';
            }
            $(event.target).removeClass('ribbon_top_button').addClass('ribbon_top_button_selected');
            toJava(javaReflector, "getOperationButton", "{topButtonName:"+event.target.textContent+"}");
        });
    ...
    this.setOperationButton = function(obTable){
        ...
        //        if(isRepaint){
        //            $("#ribbon_operation_panel").show("slide", {
        //                direction: "up"
        //            }, function(){
    ...
    this.tabHandler = function(){
        ...
        $(".tabSelected").removeClass().addClass("tab");
        //$("#tabContainer").find(".tabSelected").each(function(index){
